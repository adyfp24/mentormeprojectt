        ...
        <div className="w-4/5 mx-auto p-5 border rounded-lg shadow-xl border-blue-500 transition-transform hover:transform transition-ease-in-out hover:shadow-2xl">
          <div className="">
            ...
            <div className="w-full flex transition-transform transition-ease-in-out hover:transform hover:scale-[101%]">
              <p className="bg-blue-200 rounded-md p-2 text-white">{ReadData.deskripsimentor}</p>
            </div>
          </div>
          <div>
            <h2 className="text-2xl my-5 font-semibold text-gray-800 leading-tight ">Spesialisasi Keilmuwan</h2>
            <div className="w-full flex">
              <p className="bg-blue-200 hover:transform hover:scale-[102%] transition-transform transition-ease-in-out rounded-md p-2 text-white">{ReadData.spesialisasi}</p>
            </div>
          </div>
          <div>
            <h2 className="text-2xl my-5 font-semibold text-gray-800 leading-tight">Fee Mentoring</h2>
            <div className="w-full flex">
              <p className="bg-blue-200 rounded-md p-2 text-white hover:transform hover:scale-[102%] transition-transform transition-ease-in-out">{ReadData.fee}</p>
            </div>
          </div>
          <div>
            <h2 className="text-2xl my-5 font-semibold text-gray-800 leading-tight">Pendidikan</h2>
            <div className="w-full flex">
              <p className="bg-blue-200 hover:transform hover:scale-[102%] transition-transform transition-ease-in-out rounded-md p-2 text-white">{ReadData.pendidikan}</p>
            </div>
          </div>
          <div>
            <h2 className="text-2xl my-5 font-semibold text-gray-800 leading-tight">Hasil Penelitian</h2>
            <div className="w-full flex">
              <p className="bg-blue-200 hover:transform hover:scale-[102%] transition-transform transition-ease-in-out rounded-md p-2 text-white">{ReadData.hasilpenelitian}</p>
            </div>
          </div>
          <div>
            <h2 className="text-2xl my-5 font-semibold text-gray-800 leading-tight">Sertifikasi</h2>
            <div className="w-full flex">
              <p className="bg-blue-200 hover:transform hover:scale-[102%] transition-transform transition-ease-in-out rounded-md p-2 text-white">{ReadData.sertifikasi}</p>
            </div>
          </div>
        </div>
      </main>
