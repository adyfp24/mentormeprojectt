...
function Navbar() {
  ...
  return (
    <nav className="bg-blue-600 border-gray-200 px-6 py-4 dark:bg-gray-800">
      <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        <a href="#" className="flex items-center">
          <span className="self-center text-xl sm:text-3xl font-bold whitespace-nowrap text-white dark:text-white">mentor-me</span>
        </a>
        <div className="md:hidden justify-center ml-28 sm:ml-28 flex items-center">
          <button
            ...
            type="button"
            className="inline-flex ml-10 p-2 text-sm rounded-lg lg:hidden bg-gray-100 focus:outline-none focus:ring-2 focus:ring-white dark:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-600"
      ...
      {isDropdownOpen && (
        <ul className="dark:text-white text-white md:hidden flex flex-col p-5 list-none ml-3">
